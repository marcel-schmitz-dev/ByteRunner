class AudioHub {
    constructor() {
        this.sounds = {
            ...
            bossTransformation: new Audio('assets/audio/boss_transformation.mp3'),
            characterDiscWerfen: new Audio('assets/audio/character_disc_werfen.mp3'),
            ...
            startSoundCountdown: new Audio('assets/audio/start_sound_countdown.mp3')
        };

        // Schleifen für Hintergrund- oder Lauf-Sounds konfigurieren
